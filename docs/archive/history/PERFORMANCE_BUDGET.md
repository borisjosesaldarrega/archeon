...
Windows venv-launcher process-tree bug has been corrected; current full UI,
Ghost, music and native feasibility figures are recorded in
`UI_FRONTEND_EVALUATION.md` and `benchmarks/latest.json`.
